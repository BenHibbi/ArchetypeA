        ...
        <div className="prose prose-slate max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              vidéos, sons, plans, noms, logos, marques, créations et œuvres protégeables diverses, bases de données, etc.)
              ainsi que le site lui-même, relèvent des législations françaises et internationales sur le droit d'auteur
              et la propriété intellectuelle.
            </p>
            <p className="text-slate-600 leading-relaxed mt-4">
              Ces éléments sont la propriété exclusive de Crush Digital Atelier LLC. Toute reproduction, représentation,
              utilisation ou adaptation, sous quelque forme que ce soit, de tout ou partie de ces éléments, sans
              l'accord préalable et écrit de Crush Digital Atelier LLC, est strictement interdite.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              sur la Protection des Données (RGPD) et à la loi Informatique et Libertés. Pour plus d'informations,
            ...
            <p className="text-slate-600 leading-relaxed mt-4">
              Conformément à la loi, vous disposez d'un droit d'accès, de rectification, de suppression et
              d'opposition aux données vous concernant. Pour exercer ces droits, vous pouvez nous contacter
              à l'adresse : contact@archetype.design
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed">
              ...
              de visites. En naviguant sur ce site, vous acceptez l'utilisation de ces cookies. Vous pouvez
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed">
              Crush Digital Atelier LLC s'efforce de fournir des informations aussi précises que possible.
          ...
          <section className="mb-10">
            ...
            <p className="text-slate-600 leading-relaxed">
              Le site peut contenir des liens hypertextes vers d'autres sites. Crush Digital Atelier LLC n'exerce
              aucun contrôle sur ces sites et décline toute responsabilité quant à leur contenu ou aux pratiques
              de confidentialité de leurs exploitants.
            </p>
          </section>
